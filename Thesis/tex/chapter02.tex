...
\begin{figure}[!htp]
  ...
  \bicaption[fig:simplecomplexcell]{简单细胞和复杂细胞之间的关系}{简单细胞和复杂细胞之间的关系\supercite{galkandage2015full}}{Fig}{Monocular and binocular, simple and complex cells\supercite{galkandage2015full}}
\end{figure}
...
\begin{figure}
  ...
  \bicaption[fig:horopterdefinition]{双目视界的两种定义方式，图a是以前的球面模型截面，图b是最近研究结果定义的几何模型}{双目视界的几何定义}{Fig}{The geometry of binocular horopter}
\end{figure}
...
\begin{figure}[!htp]
  ...
  \bicaption[fig:disparitydifinition]{立体电视下的视差角定义}{立体电视下的视差角定义}{Fig}{Disparity definition}
\end{figure}
\begin{equation}
